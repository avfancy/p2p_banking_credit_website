    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-2 col-xs-6">
                <p>官方微博：</p>
                <p><img class="img-responsive" src="./images/sina.png" alt="图片加载失败"></p>
                <p><img class="img-responsive" src="./images/tecent.png" alt="图片加载失败"></p>
            </div>
            <div class="col-sm-2 col-xs-6">
                <p>官方微信：</p>
                <p><img class="img-responsive" src="./images/wx.jpg" alt="图片加载失败"></p>
            </div>
        </div>
    </div>
</footer>